...
export class RouteHandlerComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const BalcaoSubItems = [
      ...
      new SidenavItem({
        name: 'Cad. Prescritor',
        route: '/balcao/balcao-prescritor',
        parent: balcao,
        subItems: [],
        position: 1
      }),
      ...
      new SidenavItem({
        name: 'Receituário',
        route: '/balcao/balcao-receituario',
        parent: balcao,
        subItems: [],
        position: 1
      }),
      ...
      new SidenavItem({
        name: 'Pedido Direto Loja',
        route: '/balcao/balcao-pedidodireto',
        parent: balcao,
        subItems: [],
        position: 1
      }),
      ...
      new SidenavItem({
        name: 'Identificação Vendedor',
        route: '/balcao/identificacao-vendedor',
        parent: balcao,
        subItems: [],
        position: 1
      }),
      ...
      new SidenavItem({
        ...
        route: '/balcao/identificacao-cliente',
        parent: balcao,
        subItems: [],
        position: 1
      }),
      ...
      new SidenavItem({
        name: 'Estorno Farmácia Popular',
        route: '/balcao/estorno-farmacia-popular',
        parent: balcao,
        subItems: [],
        position: 1
      }),
      ...
      new SidenavItem({
        name: 'Autorizador Farmácia Popular',
        route: '/balcao/autorizador-farmacia-popular',
        parent: balcao,
        subItems: [],
        position: 1
      }),
      ...
      new SidenavItem({
        name: 'Captação CRM Produto',
        route: '/balcao/captacao-crm-produto',
        parent: balcao,
        subItems: [],
        position: 1
      })
    ...
    balcao.subItems.push(...BalcaoSubItems);
    ...
    /* Send the created Menu structure to Redux/ngrx
    (you only need to send the Top Level Item, all dropdown items will be added automatically) */

    this.store.dispatch(new fromSidenav.AddSidenavItemAction(balcao));
