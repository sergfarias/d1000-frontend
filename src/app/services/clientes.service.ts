...
export class ClientesService extends BaseFormService<AlunoModel> {
  constructor(
  ...
  public PesquisarCliente(Termo): Observable<AlunoModel[]> {
    let url = "";
  ...
  public PesquisarClienteCampo(Termo, Campo): Observable<AlunoModel[]> {
    let url = ""; 
